...
<!-- COUNTDOWN -->
<script type="text/javascript" src="<?php echo base_url('assets/lib/countdown/jquery.plugin.js'); ?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/lib/countdown/jquery.countdown.js'); ?>"></script>
<!-- ./COUNTDOWN -->
