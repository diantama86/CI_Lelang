        ...
        <div class="container main-header">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-3 logo">
                    <a href="index.html"><img alt="Kute shop - GFXFree.Net" src="assets/data/option6/logo.png" /></a>
                </div>
                        ...
                        <div class="box-vertical-megamenus">
                            ...
                            <div class="vertical-menu-content is-home">
                                <ul class="vertical-menu-list">
                                    ...
                                    <li>
                                        <a class="parent" href="#"><img class="icon-menu" alt="Funky roots" src="assets/data/13.png">Sports &amp; Outdoors</a>
                                    ...
                                    <li><a href="#"><img class="icon-menu" alt="Funky roots" src="assets/data/14.png">Smartphone &amp; Tablets</a></li>
                                    <li><a href="#"><img class="icon-menu" alt="Funky roots" src="assets/data/15.png">Health &amp; Beauty Bags</a></li>
                                    <li>
                                        <a class="parent" href="#">
                                    ...
                                    <li><a href="#"><img class="icon-menu" alt="Funky roots" src="assets/data/17.png">Toys &amp; Hobbies</a></li>
                                    <li><a href="#"><img class="icon-menu" alt="Funky roots" src="assets/data/18.png">Computers &amp; Networking</a></li>
                                    <li><a href="#"><img class="icon-menu" alt="Funky roots" src="assets/data/19.png">Laptops &amp; Accessories</a></li>
                                    <li><a href="#"><img class="icon-menu" alt="Funky roots" src="assets/data/20.png">Jewelry &amp; Watches</a></li>
                                    <li><a href="#"><img class="icon-menu" alt="Funky roots" src="assets/data/21.png">Flashlights &amp; Lamps</a></li>
                                    <li>
                                        <a href="#">
                                    ...
                                    <li class="cat-link-orther">
                                        <a href="#">
                                            <img class="icon-menu" alt="Funky roots" src="assets/data/12.png">Computers &amp; Networking
                                        </a>
                                    </li>
                                    <li class="cat-link-orther">
                                        <a href="#">
                                    ...
                                    <li class="cat-link-orther">
                                        <a href="#"><img class="icon-menu" alt="Funky roots" src="assets/data/17.png">Jewelry &amp; Watches</a></li>
                                </ul>
                            ...
                            <div class="container-fluid">
                                ...
                                <div id="navbar" class="navbar-collapse collapse">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class="dropdown">
                                            <a href="category.html" class="dropdown-toggle" data-toggle="dropdown">Antik</a>
                                    ...
                                    <ul class="nav navbar-nav navbar-right">
                                        <li><a class="link-buytheme" href="#"><i></i></a></li>
                                    </ul>
                                </div><!--/.nav-collapse -->
                            </div>
                        </nav>
