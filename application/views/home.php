...
?>
            ...
            <div class="row">
                ...
                <div class="col-sm-2 group-banner-slider" style="padding-left: 2px; margin-left:-15px; padding-right: 0;">
                    <div class=" item policy">
                        ...
                        <ul>
                            <li><a href="#">
                                    <img class="icon1" src="assets/data/option6/safe1.png" alt="Icon">
                                    <img class="icon2" src="assets/data/option6/safe2.png" alt="Icon">
                                    Pembayaran Aman
                                </a></li>
                            <li><a href="#">
                                    <img class="icon1" src="assets/data/option6/icon2.png" alt="Icon">
                                    <img class="icon2" src="assets/data/option6/icon2-1.png" alt="Icon">
                                    Barang Bervariasi</a></li>
                            <li><a href="#">
                                    <img class="icon1" src="assets/data/option6/icon3.png" alt="Icon">
                                    <img class="icon2" src="assets/data/option6/icon3-1.png" alt="Icon">
                                    Pengiriman Barang</a></li>
                            <li><a href="#">
                                    <img class="icon1" src="assets/data/option6/icon4.png" alt="Icon">
                                    <img class="icon2" src="assets/data/option6/icon4-1.png" alt="Icon">
                                    Layanan Konsumen</a></li>
                            <li><a href="#">
                                    <img class="icon1" src="assets/data/option6/icon5.png" alt="Icon">
                                    <img class="icon2" src="assets/data/option6/icon5-1.png" alt="Icon">
                                    Kepuasan Konsumen</a></li>
                        </ul>
                    </div>
                    <div class="item banner-opacity">
    ...
    <div class="content-page">
        <div class="container">
            <!-- featured category antik -->
            <div class="category-featured antik">
                <nav class="navbar nav-menu show-brand">
                    <div class="container">
                        <!-- Brand and toggle get grouped for better mobile display -->
                        <div class="navbar-brand"><a href="#"><img alt="antik" src="assets/data/icon-fashion.png" />Antik</a></div>
                        <span class="toggle-menu"></span>
                        <!-- Collect the nav links, forms, and other content for toggling -->
                        <div class="collapse navbar-collapse">           
                            <ul class="nav navbar-nav">
                                <li class="active"><a data-toggle="tab" href="#tab-4">Barang Terbaru</a></li>
                                <li><a data-toggle="tab" href="#tab-5">Terakhir Ditawar</a></li>
                                <li><a data-toggle="tab" href="#tab-4">Paling Banyak Ditawar</a></li>
                            </ul>
                        </div><!-- /.navbar-collapse -->
                    </div><!-- /.container-fluid -->
                    ...
                    <div class="row">
                        <div class="col-sm-2 sub-category-wapper">
                            <ul class="sub-category-list">
                                ...
                                <li><a href="#">Perangko</a></li>
                                <li><a href="#">Uang</a></li>
                                <li><a href="#">Pernik</a></li>
            ...
            <!-- end featured category antik -->
            <!-- featured category sports -->
            <div class="category-featured sports">
                <nav class="navbar nav-menu show-brand">
                    <div class="container">
                        <!-- Brand and toggle get grouped for better mobile display -->
                        <div class="navbar-brand"><a href="#"><img alt="antik" src="assets/data/icon-sports.png" />SPORTS</a></div>
                        <span class="toggle-menu"></span>
                        <!-- Collect the nav links, forms, and other content for toggling -->
                        <div class="collapse navbar-collapse">           
                            <ul class="nav navbar-nav">
            ...
            <div class="category-featured electronic">
                <nav class="navbar nav-menu show-brand">
                    <div class="container">
                        <!-- Brand and toggle get grouped for better mobile display -->
                        <div class="navbar-brand"><a href="#"><img alt="antik" src="assets/data/icon-electronic.png" />ELECTRONICS</a></div>
                        <span class="toggle-menu"></span>
                        <!-- Collect the nav links, forms, and other content for toggling -->
                        <div class="collapse navbar-collapse">           
                            <ul class="nav navbar-nav">
            ...
            <div class="category-featured digital">
                <nav class="navbar nav-menu show-brand">
                    <div class="container">
                        <!-- Brand and toggle get grouped for better mobile display -->
                        <div class="navbar-brand"><a href="#"><img alt="antik" src="assets/data/icon-digital.png" />DIGITAL</a></div>
                        <span class="toggle-menu"></span>
                        <!-- Collect the nav links, forms, and other content for toggling -->
                        <div class="collapse navbar-collapse">           
                            <ul class="nav navbar-nav">
                                        ...
                                        <div class="box-right">
                                            <ul class="product-list row">
                                                <li class="col-sm-4">
                                                    ...
                                                    <div class="left-block">
                                                        <a href="#">
                                                            <img class="img-responsive" alt="product" src="assets/data/option6/p5.jpg" /></a>
                                                        <div class="quick-view">
                                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                                            <a title="Add to compare" class="compare" href="#"></a>
                                                            <a title="Quick view" class="search" href="#"></a>
                                                ...
                                                <li class="col-sm-4">
                                                    ...
                                                    <div class="left-block">
                                                        <a href="#">
                                                            <img class="img-responsive" alt="product" src="assets/data/option6/p70.jpg" /></a>
                                                        <div class="quick-view">
                                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                                            <a title="Add to compare" class="compare" href="#"></a>
                                                            <a title="Quick view" class="search" href="#"></a>
                                                ...
                                                <li class="col-sm-4">
                                                    ...
                                                    <div class="left-block">
                                                        <a href="#">
                                                            <img class="img-responsive" alt="product" src="assets/data/option6/p71.jpg" /></a>
                                                        <div class="quick-view">
                                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                                            <a title="Add to compare" class="compare" href="#"></a>
                                                            <a title="Quick view" class="search" href="#"></a>
                                                ...
                                                <li class="col-sm-4">
                                                    ...
                                                    <div class="left-block">
                                                        <a href="#">
                                                            <img class="img-responsive" alt="product" src="assets/data/option6/p10.jpg" /></a>
                                                        <div class="quick-view">
                                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                                            <a title="Add to compare" class="compare" href="#"></a>
                                                            <a title="Quick view" class="search" href="#"></a>
                                                ...
                                                <li class="col-sm-4">
                                                    ...
                                                    <div class="left-block">
                                                        <a href="#">
                                                            <img class="img-responsive" alt="product" src="assets/data/option6/p6.jpg" /></a>
                                                        <div class="quick-view">
                                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                                            <a title="Add to compare" class="compare" href="#"></a>
                                                            <a title="Quick view" class="search" href="#"></a>
                                                ...
                                                <li class="col-sm-4">
                                                    ...
                                                    <div class="left-block">
                                                        <a href="#">
                                                            <img class="img-responsive" alt="product" src="assets/data/option6/p11.jpg" /></a>
                                                        <div class="quick-view">
                                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                                            <a title="Add to compare" class="compare" href="#"></a>
                                                            <a title="Quick view" class="search" href="#"></a>
            ...
            <div class="category-featured furniture">
                <nav class="navbar nav-menu show-brand">
                    <div class="container">
                        <!-- Brand and toggle get grouped for better mobile display -->
                        <div class="navbar-brand"><a href="#"><img alt="antik" src="assets/data/icon-furniture.png" />furniture</a></div>
                        <span class="toggle-menu"></span>
                        <!-- Collect the nav links, forms, and other content for toggling -->
                        <div class="collapse navbar-collapse">           
                            <ul class="nav navbar-nav">
                                        ...
                                        <div class="box-right">
                                            <ul class="product-list row">
                                                <li class="col-sm-4">
                                                    ...
                                                    <div class="left-block">
                                                        <a href="#">
                                                            <img class="img-responsive" alt="product" src="assets/data/option6/p8.jpg" /></a>
                                                        <div class="quick-view">
                                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                                            <a title="Add to compare" class="compare" href="#"></a>
                                                            <a title="Quick view" class="search" href="#"></a>
                                                ...
                                                <li class="col-sm-4">
                                                    ...
                                                    <div class="left-block">
                                                        <a href="#">
                                                            <img class="img-responsive" alt="product" src="assets/data/option6/p9.jpg" /></a>
                                                        <div class="quick-view">
                                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                                            <a title="Add to compare" class="compare" href="#"></a>
                                                            <a title="Quick view" class="search" href="#"></a>
                                                ...
                                                <li class="col-sm-4">
                                                    ...
                                                    <div class="left-block">
                                                        <a href="#">
                                                            <img class="img-responsive" alt="product" src="assets/data/option6/p7.jpg" /></a>
                                                        <div class="quick-view">
                                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                                            <a title="Add to compare" class="compare" href="#"></a>
                                                            <a title="Quick view" class="search" href="#"></a>
                                                ...
                                                <li class="col-sm-4">
                                                    ...
                                                    <div class="left-block">
                                                        <a href="#">
                                                            <img class="img-responsive" alt="product" src="assets/data/option6/p14.jpg" /></a>
                                                        <div class="quick-view">
                                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                                            <a title="Add to compare" class="compare" href="#"></a>
                                                            <a title="Quick view" class="search" href="#"></a>
                                                ...
                                                <li class="col-sm-4">
                                                    ...
                                                    <div class="left-block">
                                                        <a href="#">
                                                            <img class="img-responsive" alt="product" src="assets/data/option6/p12.jpg" /></a>
                                                        <div class="quick-view">
                                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                                            <a title="Add to compare" class="compare" href="#"></a>
                                                            <a title="Quick view" class="search" href="#"></a>
                                                ...
                                                <li class="col-sm-4">
                                                    ...
                                                    <div class="left-block">
                                                        <a href="#">
                                                            <img class="img-responsive" alt="product" src="assets/data/option6/p13.jpg" /></a>
                                                        <div class="quick-view">
                                                            <a title="Add to my wishlist" class="heart" href="#"></a>
                                                            <a title="Add to compare" class="compare" href="#"></a>
                                                            <a title="Quick view" class="search" href="#"></a>
            ...
            <div class="category-featured jewelry">
                <nav class="navbar nav-menu show-brand">
                    <div class="container">
                        <!-- Brand and toggle get grouped for better mobile display -->
                        <div class="navbar-brand"><a href="#"><img alt="antik" src="assets/data/icon-jewelry.png" />jewelry</a></div>
                        <span class="toggle-menu"></span>
                        <!-- Collect the nav links, forms, and other content for toggling -->
                        <div class="collapse navbar-collapse">           
                            <ul class="nav navbar-nav">
                    ...
                    <ul class="owl-carousel" data-dots="false" data-loop="true" data-nav = "true" data-margin = "30" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-responsive='{"0":{"items":1},"600":{"items":3},"1000":{"items":4}}'>
                        <li>
                            <div class="post-thumb image-hover2">
                                <a href="#"><img src="assets/data/option6/blog1.jpg" alt="Blog"></a>
                            </div>
                            <div class="post-desc">
                                <h5 class="post-title">
                        ...
                        <li>
                            <div class="post-thumb image-hover2">
                                <a href="#"><img src="assets/data/option6/blog2.jpg" alt="Blog"></a>
                            </div>
                            <div class="post-desc">
                                <h5 class="post-title">
                                    <a href="#">Share the love with KuteShop</a>
                        ...
                        <li>
                            <div class="post-thumb image-hover2">
                                <a href="#"><img src="assets/data/option6/blog3.jpg" alt="Blog"></a>
                            </div>
                            <div class="post-desc">
                                <h5 class="post-title">
                        ...
                        <li>
                            <div class="post-thumb image-hover2">
                                <a href="#"><img src="assets/data/option6/blog4.jpg" alt="Blog"></a>
                            </div>
                            <div class="post-desc">
                                <h5 class="post-title">
